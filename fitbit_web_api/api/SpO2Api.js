...
export default class SpO2Api {
    ...
    */
     ...
     */
    getSpO2SummaryByDate(date, callback) {
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/1/user/-/spo2/date/{date}.json', 'GET',
     ...
     */
    getSpO2SummaryByInterval(startDate, endDate, callback) {
      let postBody = null;
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/1/user/-/spo2/date/{startDate}/{endDate}.json', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
